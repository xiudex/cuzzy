...
const DEFAULT_STATE = {
  ...
  theme: 'royal', wallpaper: 'royal', language: 'tr', animSpeed: 'normal', themeReset4: false, themeReset5: false,
...
function normalizeState(raw) {
  ...
  return {
    ...
    animSpeed: ['fast', 'normal', 'slow', 'off'].includes(src.animSpeed) ? src.animSpeed : 'normal',
    adsEnabled: false,
    adPlan: 'none',
